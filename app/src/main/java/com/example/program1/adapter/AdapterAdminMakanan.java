...
public class AdapterAdminMakanan extends RecyclerView.Adapter<AdapterAdminMakanan.ViewHolder> {
    ...
    public AdapterAdminMakanan(ArrayList<Food> foodArrayList, Context c)
    {
...
//      viewHolder.orderAmount.setText(orderAmountText);
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent data = new Intent(c.getApplicationContext(), MemasukanMakanan.class);
                data.putExtra("namaMakanan", name1);
                data.putExtra("hargaMakanan", price1);
