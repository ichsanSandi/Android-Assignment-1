...
public class ModelMinuman
{
	...
	public String getIdMinuman () { return idMinuman; }
	
	public void setIdMinuman (String idMinuman) { this.idMinuman = idMinuman; }
	...
	public String getFotoMinuman () { return fotoMinuman; }
	
	public void setFotoMinuman (String fotoMinuman) { this.fotoMinuman = fotoMinuman; }
}
